$(function() {
	...
	/*$('#form-cambio-boleta-electronica input').on('blur', function() {
	    if ($("#form-cambio-boleta-electronica").valid()) {
...
function editarMails(formulario){
	...
	$('.guardarMail').on('click', function(){
		...
		/*if($(formulario).hasClass('mailForm')){
			$(formulario).valid();
		}else{

			var validator1 = $( formulario ).validate();
			validator1.element( "#correo_not_req" );

			var validator2 = $( formulario ).validate();
			validator2.element( "#confirmar_correo_not_req" );
		}*/
